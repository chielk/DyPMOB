...
\begin{document}
	...
	\begin{figure}
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{images/t4_12}
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{images/t4_13}
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth,height=10cm,keepaspectratio]{images/t4_26}
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth,height=10cm,keepaspectratio]{images/t4_28}
			\caption{t=4, p=(0.2, 0.6)}
			\label{fig:}
		\end{subfigure}
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{images/t4_47}
		...
		\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{images/t7_55}
